...
sys.path.append('/home/a/antonio-costa/entropy_estimation/')
...
def main(argv):
    ...
    mat=h5py.File('/home/a/antonio-costa/entropy_estimation/Foraging/data/PNAS2011-DataStitched.mat','r')
    ...
    f = h5py.File('/home/a/antonio-costa/entropy_estimation/Foraging/data/phspace_K_{}_m_{}.h5'.format(K_star,m_star),'w')
